 ...
 ********************************************************************/
 ...
 public class CuckooHash<K, V> {
     ...
     public V get(K key) {
         int h1 = hash1(key);
         int h2 = hash2(key);
         if (table[h1] != null && table[h1].getBucKey().equals(key))
             return table[h1].getValue();
         else if (table[h2] != null && table[h2].getBucKey().equals(key))
             return table[h2].getValue();
         return null;
     }
     ...
     public boolean remove(K key, V value) {
         int h1 = hash1(key);
         int h2 = hash2(key);
         if (table[h1] != null && table[h1].getValue().equals(value)) {
             table[h1] = null;
             return true;
         }
         else if (table[h2] != null && table[h2].getValue().equals(value)) {
             table[h2] = null;
             return true;
         }
         return false;
